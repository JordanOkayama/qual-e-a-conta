class QualEAConta {
    ...
    addAdvancedModeToggle() {
        ...
        document.getElementById('advanced-mode-checkbox').addEventListener('change', (e) => {
            ...
            this.showResult(
                this.isAdvancedMode 
                    ? '⚡ Modo Avançado ativado! Use TODAS as cartas para pontuar.' 
                    : '🎯 Modo Normal ativado! Use quantas cartas quiser.',
                'success'
            );
            setTimeout(() => this.clearResult(), 3000);
        });
    }
